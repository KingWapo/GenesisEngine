...
struct ZipFile::TZipLocalHeader
{
	...
	dword	cSize;
	dword	ucSize;
	word	fnameLen;			// Filenam string follows header.
...
// Init: Initialize the object and read the zip file directory.
// Param: resFileName - A stdio FILE* used for reading.
...
// GetFilename: Return the name of a file
...
// GetFileLen: Return the length of a file so a buffer can be allocated
// Param: i - The file index.
...
// ReadFile: Uncompress a complete file
// Param: i - The file index, *pBuf - the pre-allocated buffer
...
// ReadLargeFile: Uncompress a complete file with callbacks.
// Param: i - File index, pBuf - pre-allocated buffer
