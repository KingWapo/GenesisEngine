...
// Fast delegate from third party
...
//-----------------------------------------------------------------------
// IEvent Data
// Base type for event object hierarcy, may be used itself for simplest
// event notifications such as those that do not carry additional payload
// data. If any event needs to propagate with payload data it must be
// defined separately.
//-----------------------------------------------------------------------
class IEventData
{
